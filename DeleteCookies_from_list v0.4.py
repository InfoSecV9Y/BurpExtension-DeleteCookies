...
class BurpExtender(IBurpExtender, ISessionHandlingAction):
    ...
    def deleteCookieFromMacro(self, cookie_whitelist):
        ...
        for cookie in cookies:
            ...
            for cookie_name_list in self.cookie_name_list:
               # print("  8.Checking the cookie: '" + cookie.getName() + "' against the cookie_name_list: " + cookie_name_list)
                if cookie_name_list in cookie.getName():
                    ...
                    if cookie.getName() not in cookie_whitelist:
                        ...
                        pass    #print("   9.2.Cookie is newly received in session handling rules, hence ignored: " + cookie.getName())
            ...
            print("** Repeated cookies are deleted from Burp Suite Cookie Jar. Task completed.\n")
    ...
    def performAction(self, current_request, macro_items):
        ...
        if macro_items is None:
            ...
            print("* Burp extension started. Looking for list of macros. Number of macros to process: " + str(
                len(macro_items)))
            for i in range(len(macro_items)):  # if len(macro_items) >= 0:
                ...
                try:
                    ...
                    print("** Exception Raised: " + str(e) + "\t Value of macro_response_info:" + str(macro_response_info))
                    pass
                    ...
                    for cookie in cookies:
                        ...
                        for cookie_name in self.cookie_name_list:
                            if cookie_name in str(cookie.getName()):
                                #print("        5.Cookie name '" + cookie_name + "' found in received cookie '" + str( cookie.getName()) + "'. Adding this cookie to the white list")
